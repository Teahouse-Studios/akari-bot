                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    print(str(e))
                    if pathexist(h):
                        await app.sendGroupMessage(group, [Plain(Userp(h,h2)),Image.fromFileSystem("D:/AkariBot/usercard/"+h2+".png")])
                    else:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    print(str(e))
                    if pathexist(h):
                        await app.sendFriendMessage(friend, [Plain(Userp(h,h2)),Image.fromFileSystem("D:/AkariBot/usercard/"+h2+".png")])
                    else:
