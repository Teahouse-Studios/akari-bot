...
{play_store_version if play_store_version is not None else msg.locale.t('mcv.message.mcbv.failed')}
""" if IP.country != 'China' else '') + \
        f"""{msg.locale.t("mcv.message.mcbv.ms_store")}
{ms_store_version if ms_store_version is not None else msg.locale.t('mcv.message.mcbv.failed')}
""" +\
