...
from .dice import generate_message
...
async def _(msg: Bot.MessageSession, dices: str, dc = None):
    ...
    await msg.finish(await generate_message(msg, dices, int(times), dc))
...
async def _(msg: Bot.MessageSession):
    ...
    await msg.finish(await generate_message(msg, f'{groups[0]}D{dice_type}', int(roll_time), None))
