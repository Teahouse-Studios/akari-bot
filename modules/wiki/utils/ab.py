...
async def get_ab(msg: Bot.MessageSession | Bot.FetchedMessageSession, wiki_url, headers=None):
...
async def convert_ab_to_detailed_format(msg: Bot.MessageSession | Bot.FetchedMessageSession, abl: list):
    ablist = []
    userlist = []
    titlelist = []
    for x in abl:
