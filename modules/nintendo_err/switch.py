...
ncm = Module(
    "ncm",
    {
        ...
        3: ResultInfo(
            "Placeholder not found (issue related to the SD card in use).",
...
dmnt = Module(
    ...
    {(6500, 6599): "Cheat engine error.", (6600, 6699): "Frozen address error."},
)
...
ns = Module(
    "ns",
    {
        ...
        2101: ResultInfo(
            "Inserted region-locked Tencent-Nintendo (Chinese) game cartridge into a non-Chinese console.",
...
ssl = Module(
    ...
    {
        11: ResultInfo(
            "Returned during various NSS SEC, NSPR and NSS SSL errors.",
            "https://switchbrew.org/wiki/Error_codes",
        ),
        ...
        306: ResultInfo(
            "NSS SEC errors: -8102 (SEC_ERROR_INADEQUATE_KEY_USAGE), -8101 (SEC_ERROR_INADEQUATE_CERT_TYPE)."
        ),
        307: ResultInfo(
        ...
        311: ResultInfo(
            "NSS SSL errors: One of various malformed request errors. See Switchbrew for the complete list."
        ),
        312: ResultInfo(
            "NSS SEC errors: One of various unexpected request errors. See Switchbrew for the complete list."
        ),
        313: ResultInfo(
...
prepo = Module(
    ...
    {(1005, 1060): "HTTP error.", (2400, 2504): "Server error."},
)
...
dauth = Module(
    ...
    {
        4008: ResultInfo(
            "Console is permanently banned by Nintendo.",
...
web_applet = Module(
    "web applet",
    {
        ...
        1028: ResultInfo(
            "This error code generally indicates that your connection to the Nintendo eShop has timed out.",
...
def get(error):
    ...
    if not description or not description.description:
        ...
        ret.add_field(
            ConsoleErrorField(
                "Description",
                message_str=description.description,
                supplementary_value=code,
            )
        )
