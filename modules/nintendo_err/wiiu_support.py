...
act = Module(
    ...
    },
    {
        ...
        (
            2880,
            2899,
        ): "Not available",  # not provided/under maintenance/no longer in service
    },
)
...
eshop_api = Module("eshop(api)", {3190: ResultInfo("Wishlist is full.")})
...
eshop_unk = Module(
    ...
    {
        9622: ResultInfo(
            "Error when attempting to add funds. Check that the payment method is correct or try again later."
        )
    },
)
