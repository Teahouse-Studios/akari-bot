...
friends = Module(
    "friends",
    {
        ...
        721: ResultInfo(
            "此错误代表监护人已设置严格限制网络功能。",
            "https://www.nintendo.com.au/help/3ds-error-codes",
        ),
        803: ResultInfo(
            "This error code indicates that the online play server is currently down.",
            "https://www.nintendo.co.jp/netinfo/en_US/index.html",
        ),
        811: ResultInfo(
            "This error code indicates that the online play server is undergoing maintenance.",
            "https://www.nintendo.co.jp/netinfo/en_US/index.html",
        ),
    },
)
...
NIM_4069 = (
    ResultInfo(
        "这个错误可能会在eShop不可用时出现。如果此问题一直出现，则可能你需要为主机更换一张内存卡。",
...
nim = Module(
    "nim",
    {
        ...
        4040: ResultInfo(
            "连接eShop超时。",
            "https://en-americas-support.nintendo.com/app/answers/detail/a_id/4429",
        ),
        4069: NIM_4069,
        # in HTTP range...
        4240: ResultInfo(
            "这个错误可能代表eShop发生了暂时性的服务问题。",
            "https://en-americas-support.nintendo.com/app/answers/detail/a_id/28399",
        ),
        4305: ResultInfo(
            "这个错误常见于你从eShop下载软件的时候连接超时。",
        ...
        5602: ResultInfo(
            "无法连接至eShop。这个错误通常代表系统区域设置不正确，请在系统设置中重新设置区域，然后再试一次。"
        ),
        5687: ResultInfo(
            "这个错误常见于你无法连接至eShop。",
...
account2 = Module(
    "account",
    {
        ...
        2613: ResultInfo(
            "绑定NNID时输入了错误的邮箱或密码，或是在没有绑定NNID的情况下从eShop下载软件时出现。",
            "https://en-americas-support.nintendo.com/app/answers/detail/a_id/4314/kw/022-2613",
        ),
        2631: ResultInfo(
            "你输入的NNID已被注销，或是因为数据迁移不可用。数据迁移后NNID只会在迁入的主机可用。",
    ...
    if 4200 <= description < 4400:
        ...
        if description < 100:
            ...
            ret.add_field(
                ConsoleErrorField(
                    "HTTP状态码",
                    message_str=f"{description + 100}或{description}由于NIM中的编程错误。",
                )
            )
        else:
