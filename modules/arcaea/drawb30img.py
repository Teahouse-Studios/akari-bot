...
def drawb30(Username, b30, r10, ptt, character, path='', official=False):
    ...
    if official:
        textdraw.text((5, 5), f'Based on ArcaeaLimitedAPI by Lowiro | Generated by Teahouse Studios "Akaribot"'
                              f'\nThis service utilizes API functionality provided by and with permission from lowiro. It is not affiliated with or endorsed by lowiro.', '#3a4853', font=b30font, stroke_fill='white', stroke_width=2)
    else:
        textdraw.text((b30img.width - 490, 5), f'Based on BotArcAPI | Generated by Teahouse Studios "Akaribot"', '#3a4853', font=b30font, stroke_fill='white', stroke_width=2)
    # b30card
    i = 0
    fname = 1
    t = 0
