...
async def ask_chatgpt(msg: Bot.MessageSession, question: str, model_name: str, max_tokens: int = 4096, temperature: float = 1, top_p: float = 1) -> Tuple[List[Dict[str, str]], int]:
    if not client:
