...
fish_list = {
    'tiny': ['bitterling', 'pale-chub', 'goldfish', 'pop-eyed-goldfish', 'killifish', 'tadpole', 'guppy', 'nibble-fish',
             'neon-tetra', 'rainbow-fish', 'sea-butterfly', 'sea-horse', 'clown-fish'],
    'small': ['crucian-carp', 'ranchu-goldfish', 'crawfish', 'frog', 'freshwater-goby', 'loach', 'bluegill',
              'pond-smelt',
              'mitten-crab', 'angel-fish', 'betta', 'piranha', 'surgeon-fish', 'butterfly-fish', 'anchovy',
              'horse-mackerel',
              'barreleye'],
    'medium': ['dace', 'yellow-perch', 'tilapia', 'sweet-fish', 'cherry-salmon', 'char', 'golden-trout',
               'zebra-turkeyfish',
               'blow-fish', 'puffer-fish', 'barred-knifejaw', 'dab', 'squid'],
    'large': ['carp', 'koi', 'soft-shelled-turtle', 'snapping-turtle', 'catfish', 'giant-snakehead', 'black-bass',
              'salmon', 'arowana', 'saddled-bichir', 'red-snapper', 'football-fish'],
    'very-large': ['pike', 'stringfish', 'king-salmon',
                   'dorado', 'gar', 'sea-bass', 'olive-flounder', 'giant-trevally', 'mahi-mahi', 'ray'],
    'long-thin': ['moray-eel', 'ribbon-eel'],
    'very-large-finned': ['ocean-sunfish', 'saw-shark', 'hammerhead-shark', 'great-white-shark', 'whale-shark',
                          'suckerfish'],
    'huge': ['arapaima', 'sturgeon', 'napoleonfish', 'oarfish', 'coelacanth', 'tuna', 'blue-marlin'],
}
