    ...
    if song_info["status"] == 0:
        ...
        if usercode:
            try:
                ...
                msg.append(msgsession.locale.t('arcaea.song.message.best') + str(score) +
                           f'\n({ptt}, '
                ...
                try:
                    ...
                    if play_info["status"] == 0:
                        msg.append(msgsession.locale.t('arcaea.song.message.best') + str(play_info["content"]["record"]["score"]) +
