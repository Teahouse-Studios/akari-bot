...
_eval = plugin("eval", required_superuser=True, base=True, doc=True, load=dev_mode)
...
db = plugin("database", alias="db", required_superuser=True, base=True, doc=True, load=dev_mode)
