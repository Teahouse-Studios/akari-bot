...
hlp = plugin("help", base=True, doc=True)
...
async def _(msg: Bot.MessageSession, module: str):
    ...
    module_list = PluginsManager.return_plugins_list(
    ...
    if msg.parsed_msg:
        ...
        if help_name in module_list:
            ...
            help_ = CommandParser(
                module_,
                msg=msg,
                plugin_name=module_.plugin_name,
    ...
    if legacy_help:
        ...
        for x in module_list:
            ...
            if (
                ...
                continue
            module_.append(module_list[x].plugin_name)
        if module_:
            help_msg = MessageChain.assign(
