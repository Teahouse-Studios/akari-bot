...
ver = plugin("version", base=True, doc=True)
...
ping = plugin("ping", base=True, doc=True)
...
locale = plugin("locale", base=True, desc="{I18N:core.help.locale.desc}", alias="lang", doc=True)
...
whoami = plugin("whoami", base=True, doc=True)
...
setup = plugin("setup", base=True, desc="{I18N:core.help.setup.desc}", doc=True, alias="toggle")
...
mute = plugin("mute", base=True, doc=True, required_admin=True)
