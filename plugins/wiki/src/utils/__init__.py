...
rc_ = plugin("rc", developers=["OasisAkari"], recommend_plugins="wiki", doc=True)
...
ab_ = plugin("ab", developers=["OasisAkari"], recommend_plugins="wiki", doc=True)
...
new = plugin("newbie", developers=["OasisAkari"], recommend_plugins="wiki", doc=True)
...
usr = plugin("user", developers=["OasisAkari"], recommend_plugins="wiki", doc=True)
