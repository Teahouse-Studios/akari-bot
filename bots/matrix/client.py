...
device_id = config('matrix_device_id', cfg_type=str, secret=True)
device_name = config('matrix_device_name', cfg_type=str, secret=True)
token = config('matrix_token', cfg_type=str, secret=True)
