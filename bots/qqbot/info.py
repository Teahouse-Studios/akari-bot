...
target_c2c_prefix = f'{client_name}|C2C'
target_direct_prefix = f'{client_name}|Direct'
target_group_prefix = f'{client_name}|Group'
target_guild_prefix = f'{client_name}|Guild'
target_prefix_list = [target_c2c_prefix, target_direct_prefix, target_group_prefix, target_guild_prefix]
