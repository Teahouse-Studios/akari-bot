...
def PUser1(url, str3,ss,User,Gender,Registration):
    ...
    try:
        ...
        g = re.sub('User:', '', str3)
        from .tpg import tpg
        tpg('D:/AkariBot/Favicon/'+ss+'/Wiki.png',hh(Wikiname),User,Gender,Registration,ddk(str(dd[0])),ddk(str(dd[1])),ddk(str(dd[2])),ddk(str(dd[3])),ddk(str(dd[4])),ddk(str(dd[5])),ddk(str(dd[6])),point)
    except Exception:
        return False
def PUser1ban(url, str3,ss,User,Gender,Registration,Blockedby,Blockedtimestamp,Blockexpiry,Blockreason):
    ...
    try:
        ...
        tpgban('D:/AkariBot/Favicon/'+ss+'/Wiki.png',hh(Wikiname),User,Gender,Registration,ddk(str(dd[0])),ddk(str(dd[1])),ddk(str(dd[2])),ddk(str(dd[3])),ddk(str(dd[4])),ddk(str(dd[5])),ddk(str(dd[6])),point,Blockedby,Blockedtimestamp,Blockexpiry,hh17(Blockreason))
    except Exception:
        return False
def PUser1bann(url, str3,ss,User,Gender,Registration,Blockedby,Blockedtimestamp,Blockexpiry):
    ...
    try:
        ...
        tpgbann('D:/AkariBot/Favicon/'+ss+'/Wiki.png',hh(Wikiname),User,Gender,Registration,ddk(str(dd[0])),ddk(str(dd[1])),ddk(str(dd[2])),ddk(str(dd[3])),ddk(str(dd[4])),ddk(str(dd[5])),ddk(str(dd[6])),point,Blockedby,Blockedtimestamp,Blockexpiry)
    except Exception:
        return False