...
def docopt(doc, argvs=None, help=True, version=None, options_first=False):
    ...
    * Full documentation is available in README.rst as well as online
    ...
    argv = parse_argv(TokenStream(argvs, DocoptExit), list(options),
                      options_first)
    ...
    if argv_length > 0:
        ...
        return docopt(doc, argvs1, help, version, options_first)
    raise DocoptExit()
