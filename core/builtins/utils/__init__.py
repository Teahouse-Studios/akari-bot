...
confirm_command = [i for i in Config('confirm_command', default_confirm_command) if i.strip()] or default_confirm_command
command_prefix = [i for i in Config('command_prefix', default_command_prefix) if i.strip()] or default_confirm_command  # 消息前缀
