...
def alias_converter(value, _self) -> dict:
    if isinstance(value, str):
        return {value: _self.plugin_name}
    if isinstance(value, (tuple, list)):
        return {x: _self.plugin_name for x in value}
    return value
...
class Plugin:
    ...
    recommend_plugins: list = field(converter=convert_list)
    ...
    def to_dict(self):
        return {
            ...
            "alias": self.alias,
            "recommend_plugins": self.recommend_plugins,
